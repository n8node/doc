...
const navItems = [
  ...
  { href: "/admin/generation", label: "Генерация изображений", icon: "🖼️" },
...
export function AdminSidebar() {
  ...
  const isActive = (href: string) => {
    ...
    if (pathname === "/admin/roadmap" && href === "/admin/roadmap") return true;
    ...
    if (pathname.startsWith("/admin/n8n-guide") && href === "/admin/n8n-guide") return true;
    ...
    if (pathname === "/admin/generation" && href === "/admin/generation") return true;
