import type { AiEmbeddingResult, AiAnalysisResult, AiEmbeddingOptions, ChatMessage, ChatCompletionResult } from "./types";

export abstract class AiProvider {
  abstract generateEmbedding(text: string, options?: AiEmbeddingOptions): Promise<AiEmbeddingResult>;
